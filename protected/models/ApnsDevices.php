 ...
 */
class ApnsDevices extends DTActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('appname, deviceuid, devicename, devicemodel, deviceversion, create_time, create_user_id, update_time, update_user_id', 'required'),
            array('devicetoken', 'length', 'max' => 64),
            
            array('appname', 'UniqueAttributesValidator', 'with'=>'deviceuid','message'=>'unique_device'),
            array('appname', 'UniqueAttributesValidator', 'with'=>'devicetoken','message'=>'unique_token'),
            ...
            array('pid, clientid, appname, appversion, deviceuid, devicetoken, devicename, devicemodel, deviceversion, pushbadge, pushalert, pushsound, development, status, create_time, create_user_id, update_time, update_user_id', 'safe', 'on' => 'search'),
        );
    }
